...
def main():
    ...
    print(
        "This CLI will ask you which services you'd like to use and more. If you'd like more information about a "
    ...
    if services_classed["ms"].__contains__("plex"):
        ...
        if services_classed["servarr"].__contains__("sonarr") or services_classed[
            "servarr"
        ].__contains__("radarr"):
    ...
    if services.__contains__("plex"):
        print(
            "If you have a PleX claim token, enter it now. Otherwise, just press enter.",
            end=" ",
        )
        plex_claim = input()
    ...
    print(
        'Process complete. You can now run "docker compose up -d" to start your containers.'
    )
    print(
        "Thank you for using EZarr. If you experience any issues or have feature requests, add them to our issues."
    )
